        ...
        <section className='mr-5'>
            <div className={burgerIngredientsStyles.container}>
                ...
                <div ref={tabsRef} className={burgerIngredientsStyles.categories}>
                    <Tab value="buns" active={current === 'buns'} onClick={() => {setCurrent('buns'); scrollView(bunsRef)}}>
                        Булки
                    </Tab>
                    <Tab value="sauces" active={current === 'sauces'} onClick={() => {setCurrent('sauces'); scrollView(saucesRef)}}>
                        Соусы
                    </Tab>
                    <Tab value="mains" active={current === 'mains'} onClick={() => {setCurrent('mains'); scrollView(mainsRef)}}>
                        Начинки
                    </Tab>
                </div>
